...
// BUG  ==>> user is able to Vote > 1
// Soln -->> Store _id of review in User DB
...
const ReviewsCard = ({
  ...
  return (
    <div className="h-fit w-full p-6 border-x-[1px] border-b-[1px] dark:border-custom">
...
//   useEffect(() => {
//     voteHandler(noOfLikes, liked, noOFDisLikes, disliked);
...
//               className="w-10 text-sm cursor-pointer"
//             >
//               <CiEdit size={18} className={`inline  transition-all`} />
//             </button>
//           )}
//           <button
//             onClick={() => {
//               if (noOFDisLikes > dislikes) {
//                 setDisliked(dislikedBy);
//                 setIsDisLiked(false);
//                 setNoOfDislikes((prev) => prev - 1);
//               }
//               if (noOfLikes === likes) {
//                 setLiked((prev) => [...prev, userid!]);
//                 setIsLiked(true);
